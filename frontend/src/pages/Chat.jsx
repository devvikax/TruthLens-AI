    ...
    try {
      if (sessionId) {
        ...
        if (query.includes('10') || query.includes('simply') || query.includes('सरल')) {
          ...
          botText = language === 'en'
            ? `Copy this message to reply: "Hi! I verified this info on TruthLens-AI, and it flags it as ${trust > 40 ? 'caution advised' : 'misleading'} because fact-checks debunk the cures. Here is the link to read more: https://truthlens-ai.com/results"`
