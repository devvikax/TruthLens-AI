    ...
    <div className="container animate-fade" style={{ padding: 'var(--space-2xl) 0', display: 'flex', flexDirection: 'column', gap: 'var(--space-2xl)' }}>
      ...
      <section style={{ textAlign: 'center', maxWidth: '700px', margin: '0 auto' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '1.05rem', lineHeight: '1.6' }}>
          {language === 'en'
            ? 'TruthLens AI was built during a hackathon to encourage responsible media consumption. We bridge the gap between complex fact-checking databases and everyday social sharing.'
